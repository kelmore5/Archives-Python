...
#first seven characters  - test each one
#test first 3 upper, middle lower, last 3 upper
#if true, get middle
#delete first character
#iterate through

#turn string into list
#change list into list of booleans (based on capital/lowercase)
#look for pattern: true, true, true, false, true, true, true

string = string.split("\n")
string = "".join(string)

stringBools = list(string)
stringBools = [k.istitle() for k in string]

#looking for the pattern 3 true, 1 false, 3 true
pattern = [False, True, True, True, False, True, True, True, False]

small = []

k = 0
while k < len(stringBools):
    subList = stringBools[k:k+9]
    if subList == pattern:
        small += [string[k+4]]
    k += 1
